...
type NetworkInfo = Awaited<ReturnType<typeof checkNetwork>>;
type ContractVerification = Awaited<ReturnType<typeof verifyContractConnection>>;

export default function ContractTest() {
  const [isLoading, setIsLoading] = useState(true);
  const [networkInfo, setNetworkInfo] = useState<NetworkInfo | null>(null);
  const [contractInfo, setContractInfo] = useState<ContractVerification | null>(null);
